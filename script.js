...
// Tambah berita (admin) dengan URL gambar
...
if(form){
    form.addEventListener('submit', e => {
        ...
        const imageURL = document.getElementById('image-url').value.trim(); // ganti input file menjadi input URL

        news.push({title, content, image: imageURL || null, comments: []});
        saveNews();
        renderNewsAdmin();
        renderNews();
        form.reset();
